...
class SummaryProcessor:
    ...
    def cluster_runner(
        ...
        return sentences, embeddings, summary_sentence_indices
    ...
    def run(
        ...
        if sentences:
            sentences, _, sentence_indices = self.cluster_runner(sentences, ratio, algorithm, use_first, num_sentences)
